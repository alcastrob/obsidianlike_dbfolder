...
- Gestión de columnas (añadir, renombrar, eliminar, reordenar arrastrando por el tirador ⋮⋮ del encabezado), **filtros con grupos anidados AND/OR**, y orden múltiple, por vista.
